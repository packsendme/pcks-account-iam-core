...
public class UserController {
	...
	@RequestMapping(method = RequestMethod.POST, path="/validate/access/username/{username}", 
	produces = {MediaType.APPLICATION_JSON_VALUE},
	consumes = {MediaType.APPLICATION_JSON_VALUE})
	...
	@RequestMapping(method = RequestMethod.GET, path="/validate/access/smscode/{username}/{smscode}", 
	produces = {MediaType.APPLICATION_JSON_VALUE},
	consumes = {MediaType.APPLICATION_JSON_VALUE})
